...
<html lang="ja">
  <head>
    ...
    @vite('resources/css/company-info.css')
  </head>
    ...
    <main>
			...
			<article class="info">
				...
				<dl class="info-item">
					<dt>本社所在地</dt>
					<dd>
						〒811-4239<br class="sp-br">
						福岡県遠賀郡岡垣町野間南5-1 ルシオーレ302号室
					</dd>
				</dl>
				<dl class="info-item">
					<dt>電話番号</dt>
			...
			<figure class="map">
				<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6627.600361912061!2d130.6055182!3d33.8432634!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x354232be1c86f99d%3A0x99d67ee02a3db387!2z44CSODExLTQyMzkg56aP5bKh55yM6YGg6LOA6YOh5bKh5Z6j55S66YeO6ZaT5Y2X77yV4oiS77yRIOODq-OCt-OCquODvOODrA!5e0!3m2!1sja!2sjp!4v1739772210160!5m2!1sja!2sjp" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
			</figure>
			<article class="company-link-box">
				<a href="{{ route('company.philosophy') }}">
					<article class="company-link">
						<div class="link-name">
							<p>経営理念</p>
							<p class="name-sub">PHILOSOPHY</p>
						</div>
        ...
        <article class="con-box-all">
          <article class="con-box">
            <a href="{{ route('contact.form') }}">
              ...
              <p class="con-info">詳しくはこちら<img src="{{ asset('images/blue_arrow.png') }}" alt="矢印"></p>
